...
def i1Ii1i1I11Iii ( list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
 ...
 OoO0O00O0oo0O = [ ' ' , ' ' , ' ' ]
 I1i1i1 . create ('[COLOR ghostwhite][B] Speed Test Powered By Jarvis[/B][/COLOR]' , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
...
class O0iIiIIIIIii ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  OOo = xbmcgui . Dialog ( )
  OOo . ok ( "[COLOR ghostwhite][B] Speed Test Powered By Jarvis[/COLOR][/B]" ,"[COLOR red]2 Mbps + For SD Content [/COLOR]", "[COLOR orange]7 Mbps + For HD Content [/COLOR]","[COLOR green]15 Mbps + For 1080P Content[/COLOR]" )
  self . close ( )
  if 74 - 74: O0 / i1IIi
