...
ORDER          = ['placenta','neptune','deathstreams','deathstreamsrd', 'metalliq','trakt']
...
TRAKTID = { 
	...
	'deathstreams': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'deathstreams_trakt'),
	...
	'deathstreamsrd': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'deathstreamsrd_trakt'),
